#ifndef _ROS_dynamixel_workbench_msgs_DynamixelMX_h
#define _ROS_dynamixel_workbench_msgs_DynamixelMX_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class DynamixelMX : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "dynamixel_workbench_msgs/DynamixelMX"; };
    const char * getMD5(){ return "9c83070bb7d2f8c4166fe16523f12aac"; };
