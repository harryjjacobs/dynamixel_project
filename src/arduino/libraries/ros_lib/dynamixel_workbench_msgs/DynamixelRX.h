#ifndef _ROS_dynamixel_workbench_msgs_DynamixelRX_h
#define _ROS_dynamixel_workbench_msgs_DynamixelRX_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class DynamixelRX : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "dynamixel_workbench_msgs/DynamixelRX"; };
