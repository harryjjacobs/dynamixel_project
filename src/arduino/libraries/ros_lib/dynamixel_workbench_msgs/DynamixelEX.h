#ifndef _ROS_dynamixel_workbench_msgs_DynamixelEX_h
#define _ROS_dynamixel_workbench_msgs_DynamixelEX_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class DynamixelEX : public ros::Msg
  {
    public:
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 7) = (u_punch.base >> (8 * 7)) & 0xFF;
      ...
      u_sensed_current.real = this->sensed_current;
      *(outbuffer + offset + 0) = (u_sensed_current.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_sensed_current.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_sensed_current.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_sensed_current.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_sensed_current.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_sensed_current.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_sensed_current.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_sensed_current.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->sensed_current);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_sensed_current.base = 0;
      u_sensed_current.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_sensed_current.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_sensed_current.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_sensed_current.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_sensed_current.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_sensed_current.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_sensed_current.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_sensed_current.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->sensed_current = u_sensed_current.real;
      offset += sizeof(this->sensed_current);
     return offset;
    }

    const char * getType(){ return "dynamixel_workbench_msgs/DynamixelEX"; };
    const char * getMD5(){ return "ae49dac55253508dbc88acad15a583c5"; };
