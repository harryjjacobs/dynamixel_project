#ifndef _ROS_dynamixel_workbench_msgs_DynamixelMX64_h
#define _ROS_dynamixel_workbench_msgs_DynamixelMX64_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class DynamixelMX64 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "dynamixel_workbench_msgs/DynamixelMX64"; };
    const char * getMD5(){ return "0aecc698fc2b6f7ba1fae4a45202b0bf"; };
